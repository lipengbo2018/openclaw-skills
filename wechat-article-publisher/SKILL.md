...
- **默认配置**：
  ...
  - 配图数量：3张横屏图片（16:9）
  - 排版主题：根据文章内容自动选择
  - 写作风格：默认使用用户的自定义风格（见下方"写作风格规则"章节）

## 写作风格规则（用户默认风格）

当用户需要创作文章时，根据内容类型选择以下风格：

### 风格一：自然分享流（观点分享用）

**适合**：经验复盘、故事分享、个人感悟、热点评论

| 维度 | 规则 |
|------|------|
| **心态** | 敢于自曝其短，"菜"没关系，真实最重要 |
| **开头** | 热点事件/现象引入，直接开聊，不用自我介绍 |
| **语气** | 像跟朋友聊天，接地气，不装 |
| **句子** | 短句为主，一行一个点 |
| **结构** | 热点引入 → 观点展开 → 案例论证 → 总结 |
| **数据** | 真实具体，带入感强 |
| **结尾** | 引导互动 + 观点升华 |
